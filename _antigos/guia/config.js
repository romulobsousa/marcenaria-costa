/* =====================================================================
   ...
   Os dois valores do Supabase você pega em:
   Supabase → seu projeto → Settings → API
     • Project URL      →  SUPABASE_URL
     • anon public key  →  SUPABASE_CHAVE

   A chave "anon" é pública de propósito, pode ficar aqui. Quem protege
   os dados é o RLS que o banco.sql ativou: sem login, o banco não
   devolve nada.
   ===================================================================== */
